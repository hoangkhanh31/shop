...
@include('admin.alert')
@if (count($products) != 0)
<form class="bg0 p-t-75 p-b-70" method="POST">
    <div class="container">
        <div class="row">
                                ...
                                <div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
                                    <select class="js-select2 select2-hidden-accessible" name="time" tabindex="-1"
                                        ...
                                        dir="ltr" style="width: 143px;"><span class="selection"><span
                                                ...
                                                aria-labelledby="select2-time-r6-container"><span
                                                    class="select2-selection__rendered" id="select2-time-r6-container"
                    ...
                    <div class="flex-w flex-t bor12 p-t-15 p-b-30">
                        <div class="w-100 p-r-18 p-r-0-sm w-full-ssm">
                            <div class="p-t-15">
                                ...
                                <div class="bor8 bg0 m-b-22">
                                    <textarea class="stext-111 w-100 cl8 plh3 p-lr-15" type="text" name="content" placeholder="Ghi Chú" rows="4"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
